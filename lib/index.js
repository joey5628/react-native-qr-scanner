...
export default class QRScanner extends React.Component {
    ...
    render() {
        const { top, width = 250, height = 250, maskColor, borderColor, borderWidth, cornerSize, cornerColor, cornerBorderWidth, openLight, renderTopView, renderBottomView, onCameraReady, onMountError, onStatusChange, permissionDialogTitle, permissionDialogMessage } = this.props;
        ...
        return (<View style={styles.container}>
                <RNCamera style={styles.preview} type={RNCamera.Constants.Type.back} flashMode={flashMode} onBarCodeRead={this.onBarCodeRead} permissionDialogTitle={permissionDialogTitle} permissionDialogMessage={permissionDialogMessage} onCameraReady={onCameraReady} onMountError={onMountError} onStatusChange={onStatusChange}/>
