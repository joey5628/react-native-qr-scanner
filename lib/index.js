...
import { View, Dimensions, StyleSheet, Animated, Image, Easing, } from "react-native";
...
export default class QRScanner extends React.Component {
    ...
    renderScanBar() {
        ...
        if (isShowScanBar) {
            ...
            if (React.isValidElement(scanBar)) {
                ...
                scanBarDom = (<Image style={styles.scanBar} source={require('../imgs/line.png')}/>);
            }
    ...
    render() {
        const { top, width = 250, height = 250, maskColor, borderColor, borderWidth, cornerSize, cornerColor, cornerBorderWidth, openLight, renderTopView, renderBottomView, onCameraReady, onMountError, onStatusChange, permissionDialogTitle, permissionDialogMessage, androidCameraPermissionOptions } = this.props;
        ...
        return (<View style={styles.container}>
                <RNCamera style={styles.preview} type={RNCamera.Constants.Type.back} flashMode={flashMode} onBarCodeRead={this.onBarCodeRead} permissionDialogTitle={permissionDialogTitle} permissionDialogMessage={permissionDialogMessage} androidCameraPermissionOptions={androidCameraPermissionOptions} onCameraReady={onCameraReady} onMountError={onMountError} onStatusChange={onStatusChange}/>
